<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="FSC0101_25.aspx.cs" Inherits="FSC_FSC0_FSC0101_25" %>
    ...
    <div id="div1" runat="server">
        <asp:GridView ID="GridViewA" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Apply_date" HeaderText="送出申請日期" />
