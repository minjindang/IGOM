<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false"
    CodeFile="FSC3117_01.aspx.vb" Inherits="FSC3117_01" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">--%>
                    ...
                    <tr>
                        <td align="center" colspan="4" class="TdHeightLight">
                            ...
                            <asp:Button ID="btnUpdate" runat="server" Text="更新" Visible="false" />
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="員工姓名">
                                     ...
                                     <asp:TemplateField HeaderText="上班時間">
                                                ...
                                                <headerstyle horizontalalign="Center" verticalalign="Middle" width="45px" />
                                                <itemtemplate>
                                                <asp:TextBox ID="gvTbPKSTIME" runat="server" Text='<%# Eval("PKSTIME")%>'/>
                                        </itemtemplate>
                                     </asp:TemplateField>
                                     <asp:TemplateField HeaderText="下班時間">
                                                ...
                                                <headerstyle horizontalalign="Center" verticalalign="Middle" width="45px" />
                                                <itemtemplate>
                                                <asp:TextBox ID="gvTbPKETIME" runat="server" Text='<%# Eval("PKETIME")%>'/>
                                        </itemtemplate>
                                     </asp:TemplateField>
                                            <asp:TemplateField HeaderText="出勤狀況">
                                                ...
                                                <itemtemplate>
                                            <asp:DropDownList ID="gvDdlPKWKTPE" runat="server"></asp:DropDownList>
