<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false"
    CodeFile="FSC2124_01.aspx.vb" Inherits="FSC2124_01" %>
                            ...
                            <asp:GridView ID="gvlist" runat="server" AutoGenerateColumns="false" BorderWidth="0px" PageSize="30"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="員工編號">
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px" />
                                        <Itemtemplate>
                                            <asp:Label ID="lbPKCARD" runat="server" Text='<%# Eval("id_card")%>'></asp:Label><br />
                                            </Itemtemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="員工姓名">
                                              ...
                                              <headerstyle horizontalalign="Center" verticalalign="Middle" width="60px" />
                                              <itemtemplate>
                                          <asp:Label ID="lbPKNAME" runat="server"  Text='<%# Eval("User_Name")%>'></asp:Label><br/>                    
                                              </itemtemplate>
                                     </asp:TemplateField>
                                     <asp:TemplateField HeaderText="上班日期">
                                            ...
                                            <asp:TemplateField HeaderText="原出勤狀況">
                                     ...
                                     <asp:TemplateField HeaderText="註銷人員">
                                                <itemstyle horizontalalign="Center" />
                                                <headerstyle horizontalalign="Center" verticalalign="Middle" />
                                                <itemtemplate>
                                            <asp:Label ID="lbChange_userid" runat="server"  Text='<%# Eval("Change_username")%>' ></asp:Label>
                                        </itemtemplate>
                                     </asp:TemplateField>
                                     <asp:TemplateField HeaderText="註銷時間">
                                                <itemstyle horizontalalign="Center" />
                                                <headerstyle horizontalalign="Center" verticalalign="Middle" />
                                                <itemtemplate>
