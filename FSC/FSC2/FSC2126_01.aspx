<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false"
    CodeFile="FSC2126_01.aspx.vb" Inherits="FSC2126_01" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
        ...
        <tr>
            <td class="htmltable_Left" style="width: 100px"><span style="color:Red">*</span>查詢日期</td>
        ...
        <tr>
            <td align="center" colspan="4" class="TdHeightLight">
                ...
                <input id="Reset" type="button" runat="server" value="重填" visible="false" />
                        ...
                        <asp:TemplateField HeaderText="員工姓名">
                            ...
                            <asp:TemplateField HeaderText="上班日期">
                                ...
                                <asp:TemplateField HeaderText="上班刷卡時間">
                                    ...
                                    <itemtemplate>
                                <uc4:ucshowtime id="UcShowTime1" runat="server"  Text='<%# Eval("PKSTIME")%>' />
                            </itemtemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="下班刷卡時間">
                                    ...
                                    <headerstyle horizontalalign="Center" verticalalign="Middle" />
                                    <itemtemplate>                         
                                <uc4:ucshowtime id="UcShowTime2" runat="server"  Text='<%# Eval("PKETIME")%>' />
                            </itemtemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="出勤狀況">
                                    ...
                                    <headerstyle horizontalalign="Center" verticalalign="Middle" />
                                    <itemtemplate>
                                <asp:Label ID="lbCHPKWKTPE" runat="server"  Text='<%# Eval("PKWKTPE")%>' ></asp:Label>
