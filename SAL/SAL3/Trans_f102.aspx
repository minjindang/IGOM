<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Trans_f102.aspx.cs" Inherits="SAL_SAL3_Trans_f102" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <script language="javascript">   
   ...
   <br>
        ...
        <table  id="MySearch" style="DISPLAY:none">
	        <tr>
		        <td>
		            身分證字號
		        </td>
    ...
    border="0" cellpadding="0" cellspacing="0" style="width:100%">
        <tr>
            <td>
                ...
                BorderWidth="0" CellPadding="3" CellSpacing="3"  >
                    <Columns>
