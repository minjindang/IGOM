...
public partial class SAL3122_06 : BaseWebForm
{
        ...
        if (check_data_upemp()) 
        {
            ...
            for (int i = 0; i < GridView_SaUpemp.Rows.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    if (TextBox_tabid.Text == "E0001")
                    {
                        DropDownList kind = (DropDownList)GridView_SaUpemp.Rows[i].Cells[4].FindControl("DropDownList_Kind1");
                        t_kind = kind.SelectedValue;
                        TextBox qty = (TextBox)GridView_SaUpemp.Rows[i].Cells[5].FindControl("TextBox_Qty");
                        t_qty = qty.Text;
                        DropDownList ddlclass = (DropDownList)GridView_SaUpemp.Rows[i].Cells[6].FindControl("DropDownList_Class");
                        t_class = ddlclass.SelectedValue;
                    }

                    TextBox amt = (TextBox)GridView_SaUpemp.Rows[i].Cells[8].FindControl("TextBox_amt");
                    t_amt = amt.Text;

                    if (TextBox_tabid.Text == "E0004")
                    {
                        DropDownList kind = (DropDownList)GridView_SaUpemp.Rows[i].Cells[7].FindControl("DropDownList_Kind2");
                        t_kind = kind.SelectedValue;
                    }    
