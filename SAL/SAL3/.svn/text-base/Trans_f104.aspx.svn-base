<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Trans_f104.aspx.cs" Inherits="SAL_SAL3_Trans_f104" %>
                ...
                BorderWidth="0" CellPadding="3" CellSpacing="3"  >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="支領數額">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_amt" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "AMT") %>'></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="19%"/>
                        </asp:TemplateField>                     
            ...
            <td>
                ...
                BorderWidth="0" CellPadding="3" CellSpacing="3"  >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="支領數額">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_amt" runat="server" Text='<%# Eval("AMT") %>'></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" Width="19%"/>
                        </asp:TemplateField>                        
