...
public partial class SAL_SAL3_Trans_f107 : System.Web.UI.Page
{
    ...
    protected void SQL_saupemp() //GridView_SaUpemp
    {
        ...
        SAL3122 sal3122 = new SAL3122();
        DataTable data = sal3122.queryf107saupemp(TextBox_ym.Text, TextBox_upempStr.Text, TextBox_tabid.Text); 
        if (data != null && data.Rows.Count > 0)
        {
   ...
   /*   if (TextBox_tabid.Text == "F0001-1") //公務人員主管加給 '001'
        ...
        else if (TextBox_tabid.Text == "C1002 ")  //醫事人員主管加給對照表
        {
            ...
            //' G1001-0、G1002-0、G1003-0 都不會在個人呈現，所以不用記                
    ...
    protected void Button_search_Click(object sender, EventArgs e)
    {
        ...
        SAL3122 sal3122 = new SAL3122();
        DataTable data = sal3122.queryf107search(TextBox_baseStr.Text, vIDNo, vName);
        if (data != null && data.Rows.Count > 0)
        {
            GridView_Search.DataSource = data;
            GridView_Search.DataBind();
        ...
        if (check_data_search())
        {
            ...
            { 
                  ...
                  if (cb.Checked)
                  {
                     ...
                     SAL3122 sal3122 = new SAL3122();
                     sal3122.queryf107insert(TextBox_ym.Text, t_orgid, TextBox_tabid.Text, t_seqno, t_amt, t_type, t_qty
                         , t_FType, t_DType);
                  }
            }
        ...
        if (check_data_upemp()) 
        {
            ...
            for (int i = 0; i < GridView_SaUpemp.Rows.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    sal3122.queryf107update(TextBox_ym.Text, t_orgid, TextBox_tabid.Text, t_seqno, t_amt, t_type, t_qty
                        , t_FType, t_DType);
                }
            }
            SQL_saupemp();
