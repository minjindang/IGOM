...
public partial class SAL3122_04 : BaseWebForm
{
        ...
        if (check_data_upemp()) 
        {
            ...
            for (int i = 0; i < GridView_SaUpemp.Rows.Count; i++)
            {
                ...
                if (cb.Checked)
                {
                    ...
                    if (TextBox_tabid.Text == "C1010")
                    {
                        DropDownList type = (DropDownList)GridView_SaUpemp.Rows[i].Cells[5].FindControl("DropDownList_Kind1");
                        t_type = type.SelectedValue;
                    }
                    else if (TextBox_tabid.Text == "C1011")
                    {
                        DropDownList type = (DropDownList)GridView_SaUpemp.Rows[i].Cells[6].FindControl("DropDownList_Kind3");
                        t_type = type.SelectedValue;
                    }
                    else
                    {
                    ...
                    TextBox amt = (TextBox)GridView_SaUpemp.Rows[i].Cells[7].FindControl("TextBox_amt");
                    t_amt = amt.Text;                   
