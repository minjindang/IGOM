<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="SAL3122_03.aspx.cs" Inherits="SAL3122_03" %>
                   ...
                   <AlternatingRowStyle CssClass="AlternatingRow" />
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="經費類別">
                          ...
                          <asp:TemplateField HeaderText="類(級)別">
                            <ItemTemplate>
                                <asp:DropDownList ID="DropDownList_Kind" runat="server" SelectedValue='<%# Eval("KIND") %>'>
                                    <asp:ListItem Text="國中處、室主任-支本薪245元以上者" Value="1" ></asp:ListItem>
                                    <asp:ListItem Text="國中處、室主任-支本薪230元以下者" Value="2" ></asp:ListItem>
                                    <asp:ListItem Text="專任組長-支本薪245元以上者" Value="3" ></asp:ListItem>
                                    <asp:ListItem Text="專任組長-支本薪230元以下者" Value="4" ></asp:ListItem>
                                    <asp:ListItem Text="幹事、導工" Value="5" ></asp:ListItem>
                                    <asp:ListItem Text="事務員、書記" Value="6" ></asp:ListItem>
                                    <asp:ListItem Text="雇員" Value="7" ></asp:ListItem>
                                </asp:DropDownList>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        ...
                        <asp:TemplateField HeaderText="支領數額">
                         ...
                         <asp:TemplateField HeaderText="增支">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_qty" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "QTY") %>'></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                  ...
                  <RowStyle CssClass="Row" />
                   <AlternatingRowStyle CssClass="AlternatingRow" />
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="支領數額">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_amt" runat="server" Width="60px" Text='<%# Eval("AMT") %>' Visible="True"></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left"/>
                        </asp:TemplateField>
                            <asp:TemplateField HeaderText="增支">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_qty" runat="server" Width="50px" Text='<%# Eval("QTY") %>'></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
