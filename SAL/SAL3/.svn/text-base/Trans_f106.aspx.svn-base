<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Trans_f106.aspx.cs" Inherits="SAL_SAL3_Trans_f106" %>
            ...
            <td>
                ...
                BorderWidth="0" CellPadding="3" CellSpacing="3"  >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="天數">
                            <ItemTemplate>
                                <asp:TextBox ID="TextBox_qty" runat="server" Width="30px" Text='<%# Eval("QTY") %>'></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField> 
