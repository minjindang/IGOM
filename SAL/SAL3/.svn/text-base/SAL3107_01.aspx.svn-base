<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="SAL3107_01.aspx.cs" Inherits="SAL_SAL3_SAL3107_01" %>
        ...
        <table class="tableStyle99" width="100%">
            ...
            <tr>
                <td align="center" colspan="4" clsee="htmltable_Bottom">
                    <asp:Button ID="Button_sabase" runat="server" Text="帶入主管加給" OnClick="Button_sabase_Click" />
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                CellPadding="1" CellSpacing="1" BorderWidth="0px" Width="100%" CssClass="Grid"
                                OnRowDataBound="gvResult_RowDataBound" EnableModelValidation="True" PageSize="30"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="身分證字號">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="kdc" runat="server" Text='<%# Eval("BOUNS_KDC") %>' Visible="False" />
                                            <asp:Label ID="series" runat="server" Text='<%# Eval("BOUNS_KDC_SERIES") %>' Visible="False" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="主管加給">
                                        <ItemTemplate>
                                            <uc3:ucSaCode ID="cmbBossAdd" runat="server" Code_Kind="P" Code_sys="001" Code_type="004"
                                                Code_no='<%# Eval("BOUNS_KDC") %>' ControlType="2" Mode="edit" OnCodeChanged="UcSaCode1_CodeChanged"
                                                ReturnEvent="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="加給金額">
                                        <ItemTemplate>
                                            <uc6:ucSaSpesup ID="UcSaSpesup1" runat="server" v_Type="004" v_No='<%# Eval("BOUNS_KDC")%>'
                                                v_Series='<%# Eval("BOUNS_KDC_SERIES") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="月數">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddl_month" runat="server" SelectedValue='<%# Eval("BOUNS_KDC_MON") %>'>
                                    ...
                                    <asp:TemplateField HeaderText="自行輸入金額">
                                        <ItemTemplate>
                                            <asp:TextBox runat="server" ID="txt_KDC_AMT" Text='<%# Bind("BOUNS_KDC_AMT") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
            ...
            <ContentTemplate>
                ...
                <table class="tableStyle99" width="100%">
                   <tr>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GridView_Base" runat="server" AutoGenerateColumns="False" Width="100%"
                                CssClass="Grid" CellPadding="1" CellSpacing="1" BorderWidth="0px" AllowPaging="True" PageSize="30"
                                OnPageIndexChanging="GridView_Base_PageIndexChanging">
                                <EmptyDataTemplate>
                                    查無資料
                                </EmptyDataTemplate>
                                <Columns>
                    ...
                    <tr>
                        <td align="right" class="TdHeightLight" style="width: 100%">
                            <uc1:Ucpager ID="Ucpager2" runat="server" GridName="GridView_Base" PSize="30" PNow="1" />
                        </td>
                    </tr>
                    <tr>
