<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Trans_f103.aspx.cs" Inherits="SAL_SAL3_Trans_f103" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="經費類別">
                          ...
                          <asp:TemplateField HeaderText="類(級)別">
                            <ItemTemplate>
                              <asp:DropDownList ID="DropDownList_Kind1" runat="server">
                                    <asp:ListItem Text="C1010" Value="1" ></asp:ListItem>
                                </asp:DropDownList>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                           ...
                           <asp:TemplateField HeaderText="類(級)別">
                            <ItemTemplate>
                                <asp:DropDownList ID="DropDownList_Kind3" runat="server">
                                    <asp:ListItem Text="C1011" Value="3" ></asp:ListItem>
                                </asp:DropDownList>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
