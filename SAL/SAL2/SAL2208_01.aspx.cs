...
// SAL2208	短程車費發放清冊
public partial class SAL_SAL2_SAL2208_01 : BaseWebForm
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string flow_id = "" + Request["flow_id"];
        SAL2208 sal2208 = new SAL2208();
        DataTable dt = sal2208.queryData(flow_id);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt = new CommonLib.DTReport(Server.MapPath("~/Report/SAL/SAL2208.mht"), dt);
            rpt.ExportFileName = "短程車費發放清冊";
            // 參數部分
