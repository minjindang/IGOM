...
Partial Class SAL_SAL2_SAL2110_01
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.Page.IsPostBack Then
            ...
            Me.TextBox_mid.Text = LoginManager.GetTicketUserData(LoginManager.LoginUserData.Account)

            ddlsaproj.DataValueField = "CODE_NO"
            ddlsaproj.DataTextField = "CODE_DESC1"
            ddlsaproj.DataSource = New SYS.Logic.CODE().GetData("002", "017")
            ddlsaproj.DataBind()
        End If
    ...
    Protected Sub reportPrint()
        v_startYYMM = (UcDate1.ROCYear + 1911).ToString() + UcDate1.Month.ToString().PadLeft(2, "0")
        v_base_prono = ddlsaproj.SelectedValue
