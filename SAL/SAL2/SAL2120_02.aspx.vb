...
Partial Class SAL2120_02
    ...
    Protected Sub ShowReport()
        ...
        Dim pdate As String = Request("pdate")
        Dim pdatez() As String = pdate.Trim.Split(",")
    ...
    Protected Function GetHtml(ByVal P_Type As String, ByVal rd As rdata) As String
        Dim rv As String = ""
        rv &= "<div align='center'>"
        rv &= "<table width='680' height='96%' border='0' cellpadding='0' cellspacing='0' style='font-family:標楷體;'>"
        ...
        If P_Type = "1" Or P_Type = "3" Then
            ...
            rv &= "        </tr>"
            rv &= "        <tr>"
            rv &= "          <td align='center' style='border-color:Black;' height='10%' width='25%' colspan='2'>所得給付日期</td>"
            ...
            rv &= "        </tr>"
            rv &= "        <tr>"
            rv &= "          <td align='center' style='border-color:Black;' height='10%' width='25%' colspan='2'>&nbsp;" & rd.inco_date & "</td>"
