...
// SAL2204	子女教育補助津貼發放清冊
public partial class SAL_SAL2_SAL2204_01 : BaseWebForm
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string flow_id = "" + Request["flow_id"];
        SAL2204 sal2204 = new SAL2204();
        DataTable dt = sal2204.queryData(flow_id);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            rpt = new CommonLib.DTReport(Server.MapPath("~/Report/SAL/SAL2204.mht"), dt);
            rpt.ExportFileName = "子女教育補助津貼發放清冊";
            // 參數部分
