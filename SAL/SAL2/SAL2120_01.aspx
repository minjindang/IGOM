<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SAL2120_01.aspx.vb" Inherits="SAL2120_01" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
                    <tr>
                        <td class="htmltable_Title" colspan="4">補充保費扣繳證明書列印(單筆)
                        </td>
                    </tr>
                    <tr>
        ...
        <asp:Label ID="lbSum" runat="server" Text="" font-size="Small"></asp:Label>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="發放種類">
                    <ItemTemplate>
                        <asp:Label ID="PAYO_KIND" runat="server" Text='<%# Eval("PAYO_KIND")%>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle />
                    <ItemStyle />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="發放種類(其他薪津)">
                    <ItemTemplate>
                        <asp:Label ID="PAYO_KIND_CODE_TYPE" runat="server" Text='<%# Eval("PAYO_KIND_CODE_TYPE")%>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle />
                    <ItemStyle />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="發放種類(其他薪津)">
                    <ItemTemplate>
                        <asp:Label ID="PAYO_KIND_CODE_NO" runat="server" Text='<%# Eval("PAYO_KIND_CODE_NO")%>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle />
                    <ItemStyle />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="日期">
                    <ItemTemplate>
                        <asp:Label ID="PAYO_DATE" runat="server" Text='<%# Eval("PAYO_DATE")%>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle />
                    <ItemStyle />
                </asp:TemplateField>
