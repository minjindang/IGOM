<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SAL4106_03.aspx.vb" Inherits="SAL4106_03" %>
        ...
        <tr>
            <td align="left" style="height: 1px" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
                    <tr>
                        <td class="htmltable_Title" colspan="4">申請區間設定-修改
                        </td>
                    </tr>
                    <tr>
                        <td class="htmltable_Left" style="width: 100px; height: 19px;"><span style="color:Red">*</span>申請類別(不可修改)</td>
                        <td class="TdHeightLight" style="width: 250px; height: 19px;">
                            <%-- <asp:DropDownList ID="ddlApply_type" runat="server" AppendDataBoundItems="True"></asp:DropDownList>--%>
                             <asp:TextBox ID="Apply_type" runat="server" ReadOnly="true"  ForeColor="graytext"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
