...
Partial Class CAR3101_03
    ...
    Protected Sub btnConfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
        ...
        Response.Redirect("CAR3101_01.aspx?op=U&result=true&buydatemaintain1=" + buydate + "&buydatemaintain2=" + buydate + "&brandnamemaintain=" + brandname + "&caridmaintain=" + carid + "&scrapdatemaintain=" + scrapdate)
