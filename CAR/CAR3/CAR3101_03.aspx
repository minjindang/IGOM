<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CAR3101_03.aspx.vb" Inherits="CAR3101_03" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
        ...
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbCarID" runat="server" AutoPostBack="True" Enabled="false" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbCCcnt" runat="server" AutoPostBack="false" MaxLength="6" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbComInsurance" runat="server" MaxLength="4" />
            </td>
        </tr>
        <tr>
