<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CAR3101_02.aspx.vb" Inherits="CAR3101_02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
        <tr>
            <td class="htmltable_Title" colspan="4">車輛基本資料維護-新增
            </td>
        </tr>
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbCarID" runat="server" MaxLength="10" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbCCcnt" runat="server" MaxLength="6" />
            </td>
        </tr>
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbbrandname" runat="server" />
            </td>
        </tr>
        <tr>
            ...
            <td class="TdHeightLight" colspan="3">
                <asp:TextBox ID="tbComInsurance" runat="server" AutoPostBack="true" MaxLength="4" Width="50"/>
            </td>
        </tr>
        <tr>
            <td class="htmltable_Left" style="width: 150px">全險日期</td>
            <td class="TdHeightLight" colspan="3">
            <uc2:UcDate ID="tbInsurance" runat="server" />
        ...
        <tr>
            ...
            <asp:Label ID="lbTip2" runat="server" ForeColor="Blue" Text="※填寫範例:101/01/01"></asp:Label>
            </td>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="維護">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Button ID="btnDelete" runat="server" Text="刪除" CommandName="remove" CommandArgument='<%#Eval("Car_id")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
