<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="CAR1102.aspx.vb" Inherits="CAR1_CAR1102" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
        ...
        <tr>
            <td class="htmltable_Left" style="width: 150px">購置年份(起~迄)
            </td>
