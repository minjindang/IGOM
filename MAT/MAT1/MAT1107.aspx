<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false"
    CodeFile="MAT1107.aspx.vb" Inherits="MAT1_MAT1107" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableStyle99">
        ...
        <tr>
            ...
            <td class="TdHeightLight">&nbsp;
                <asp:TextBox ID="material_id1" runat="server" AutoPostBack="false" />
                ~
                 <asp:TextBox ID="material_id2" runat="server" AutoPostBack="false" />
            </td>
        </tr>
        <tr>
