<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="MAT1101_02.aspx.vb" Inherits="MAT_MAT1_MAT1101_02" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tableStyle99" width="100%">
        <tr>
            <td class="htmltable_Title" colspan="4">個人領物申請
            </td>
        </tr>
        <tr>
    ...
    <div id="div1" runat="server" align="center">
        ...
        <asp:Button ID="ResetBtn" runat="server" Text="重填物料" PostBackUrl="~/MAT/MAT1/MAT1101_01.aspx" />
        <asp:Button ID="DonBtn" runat="server" Text="送出申請" />
        <asp:Button ID="BackBtn" runat="server" Text="回上頁" Visible="false" OnClick="BackBtn_Click" />
    </div>
</asp:Content>
