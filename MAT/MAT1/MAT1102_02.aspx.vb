...
Partial Class MAT_MAT1_MAT1102_02
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            BindGV(materials)
            ResetBtn.PostBackUrl = "~/MAT/MAT1/MAT1102_01.aspx?Materials=" & materials
    ...
    Protected Sub OkBtn_Click(sender As Object, e As EventArgs) Handles DonBtn.Click
        If Me.GridViewA.Rows.Count > 0 Then
            ...
            Else
                ...
                Dim msg As String = dao.Insert(txtFlowId.Text, txtApplyDate.Text, LoginManager.Depart_id, ddlUserId.SelectedValue, LoginManager.GetTicketUserData(LoginManager.LoginUserData.Account), LoginManager.OrgCode, detailDT)
                If Not String.IsNullOrEmpty(msg) Then
                    CommonFun.MsgShow(Page, CommonFun.Msg.Custom, msg)
                Else
                    'Response.Redirect("~/MAT/MAT1/MAT1102_01.aspx")
