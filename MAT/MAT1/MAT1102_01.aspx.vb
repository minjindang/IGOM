...
Partial Class MAT_MAT1_MAT1102_01
    ...
    Protected Sub OkBtn_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/MAT/MAT1/MAT1102_02.aspx?Materials=" & IIf(materialIDs.Length > 0, materialIDs.Substring(0, materialIDs.Length - 1), ""))
