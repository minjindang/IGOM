<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="MAT1102_01.aspx.vb" Inherits="MAT_MAT1_MAT1102_01" %>
        ...
        <asp:ListView ID="lvMatClass" runat="server">
            <LayoutTemplate>
                <table class="tableStyle99" width="100%">
                    <tr>
                        <td class="htmltable_Title" colspan="2">單位領物申請
                        </td>
                    </tr>
