<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="MAT3102_03.aspx.vb" Inherits="MAT3_MAT3102_03" %>
<%@ Register src="~/UControl/UcDate.ascx" tagname="UcDate" tagprefix="uc2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:HiddenField ID="hfOrgCode" runat="server" />
    <asp:HiddenField ID="hfMaterialId" runat="server" />
    <asp:HiddenField ID="hfInDate" runat="server" />
    <table class="tableStyle99" width="100%">
        <tr>
            <td class="htmltable_Title" colspan="4">物品入庫維護-維護
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 326px">
                ...
                <asp:Label ID="lbOriInCnt" runat="server" Visible="false" />
            </td>
        </tr>
        <tr>
