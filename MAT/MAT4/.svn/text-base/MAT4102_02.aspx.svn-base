<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false"
    ...
    CodeFile="MAT4102_02.aspx.vb" Inherits="MAT4102_02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Div_Approve_Query" runat="server">
        <table class="tableStyle99" width="100%">
            <tr>
                <td class="htmltable_Title" colspan="4">分類號維護-新增</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="htmltable_Bottom" colspan="4" style="border-top: none;">
                    ...
                    <asp:Button ID="btnPostBackUrl" runat="server" Text="回上頁" PostBackUrl="~/MAT/MAT4/MAT4102_01.aspx"/>
