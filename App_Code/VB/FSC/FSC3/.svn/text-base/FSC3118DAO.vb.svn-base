...
Namespace FSC.Logic
    Public Class FSC3118DAO
        ...
        Public Function GetData(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Sdate As String, ByVal Edate As String, _
            ...
            sql.AppendLine(" select k.*, sc.CODE_DESC1 as CHPKWKTPE, ")
            ...
            sql.AppendLine(" inner join sys_code sc on sc.CODE_NO=k.PKWKTPE and sc.CODE_SYS='023' and sc.CODE_TYPE='009' ")
            sql.AppendLine(" where 1=1 and k.PKWKTPE not in ('5','6') ")
            ...
            sql.AppendLine(" order by k.PKWDATE desc ")
