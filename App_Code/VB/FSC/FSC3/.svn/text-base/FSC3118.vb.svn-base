...
Namespace FSC.Logic
    Public Class FSC3118
        Private DAO As FSC3118DAO
        ...
        Public Function updatePK(ByVal yyymm As String, ByVal PKCARD As String, ByVal PKWDATE As String, ByVal PKWKTPE As String) As Boolean
