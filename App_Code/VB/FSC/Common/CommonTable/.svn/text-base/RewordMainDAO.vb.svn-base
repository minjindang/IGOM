...
Namespace FSC.Logic
    Public Class RewordMainDAO
        ...
        Public Function DeletTempData(orgcode As String, id_card As String) As Integer
            ...
            sql.AppendLine(" delete from FSC_Reword_main ")
            sql.AppendLine("    where orgcode=@orgcode and flow_id=@id_card and id_card=@id_card ")
        ...
        Public Function GetTempData(orgcode As String, id_card As String) As DataTable
            ...
            sql.AppendLine(" select * from FSC_Reword_main ")
            sql.AppendLine("    where orgcode=@orgcode and flow_id=@id_card and id_card=@id_card ")
