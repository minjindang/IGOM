...
Namespace FSCPLM.Logic
    Public Class FSCORG1DAO
        ...
        End Function
        Public Function GetDataByParentid(ByVal id As String) As DataSet
            'REMARK BY CHIHLIWANG 1030422
            'Dim StrSQL As String = String.Empty
            'StrSQL = "select distinct Depart_code, Depart_name  from FSCorg1 where Parent_depart_id=@Parent_depart_id and id<>Parent_depart_id"
            'Dim param As SqlParameter = New SqlParameter("@Parent_depart_id", SqlDbType.VarChar)
            'param.Value = id
            'Return SqlAccessHelper.ExecuteDataset(ConnectionString, CommandType.Text, StrSQL, param)

            'MODI BY CHIHLIWANG 1030422
            Dim StrSQL As String = String.Empty
            If (id = "") Then
                StrSQL = "select distinct Depart_id as Depart_code, Depart_name  from FSC_ORG where Parent_depart_id is null or Parent_depart_id=@Parent_depart_id "
            Else
                StrSQL = "select distinct Depart_id as Depart_code, Depart_name  from FSC_ORG where Parent_depart_id=@Parent_depart_id and Depart_id<>Parent_depart_id"
            End If
            Dim param As SqlParameter = New SqlParameter("@Parent_depart_id", SqlDbType.VarChar)
            param.Value = id
            Return SqlAccessHelper.ExecuteDataset(ConnectionString, CommandType.Text, StrSQL, param)
        ...
        Public Function GetData(ByVal Orgcode As String) As DataSet
            ...
            StrSQL = "select distinct Orgcode, Orgcode_name, Orgcode_shortname, Orgcode_shortname AS OrgcodeName from FSC_ORG "
        ...
        Public Function GetSeq(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Sub_depart_id As String) As Object
            ...
            sql.AppendLine(" from FSC_ORG where 1=1 ")
        ...
        Public Function GetData(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Role_id As String) As DataSet
            Dim sql As New StringBuilder
            sql.Append("select *,(select top 1 seq from FSC_ORG sf where db1.Orgcode=sf.Orgcode and db1.Depart_id=sf.Depart_id ) as seq from ( ")
            sql.Append(" SELECT distinct  Orgcode, Depart_id, Depart_name FROM FSC_ORG ")
        ...
        Public Function GetSub_depart(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Sub_departid As String) As DataSet
            Dim sql As New StringBuilder
            sql.Append("SELECT distinct Orgcode, Sub_depart_id, Sub_depart_name FROM FSC_ORG ")
        ...
        Public Function GetDepartNameByOrgcodeDepartID(ByVal Orgcode As String, ByVal DepartID As String) As DataSet
            Dim sql As New StringBuilder()
            sql.AppendLine(" select distinct *,(select top 1 seq from FSC_ORG sf where db1.Orgcode=sf.Orgcode and db1.Depart_id=sf.Depart_id and visable_flag='Y') as seq ")
            sql.AppendLine(" from (select Distinct Orgcode_shortname as OrgcodeName, Orgcode_name as LongOrgcodeName, Orgcode_name, ")
            sql.AppendLine("       Orgcode, Depart_id as DepartID, Depart_id, Depart_name as DepartName, Depart_name, Sub_depart_id, Sub_depart_name from FSC_ORG where visable_flag='Y') as db1 ")
            sql.AppendLine(" where ")
        ...
        Public Function GetDataByODS(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Sub_depart_id As String) As DataSet
            Dim StrSQL As String = String.Empty
            StrSQL = "select distinct Orgcode,* from FSC_ORG Where "
            If Not String.IsNullOrEmpty(Orgcode) Then
        ...
        Public Function GetDataByOrgcode(ByVal Orgcode As String) As DataSet
            ...
            sql.AppendLine(" select *,(select top 1 seq from FSC_ORG sf where db1.Orgcode=sf.Orgcode and db1.Depart_id=sf.Depart_id and visable_flag='Y') as seq ")
            sql.AppendLine(" from (select Distinct Orgcode_shortname as OrgcodeName, Orgcode_name as LongOrgcodeName, Orgcode_name, ")
            sql.AppendLine("       Orgcode, Depart_id as DepartID, Depart_id, Depart_name as DepartName, Depart_name from FSC_ORG where visable_flag='Y') as db1 ")
        ...
        Public Function GetDepartName(ByVal Orgcode As String, ByVal DepartID As String) As DataSet
            Dim StrSQL As String = String.Empty
            StrSQL = "select distinct Depart_name as DepartName, Depart_id as DepartID, Orgcode from FSC_ORG Where Orgcode=@orgcode and depart_id=@depart_id "
        ...
        Public Function GetDataByCondition(ByVal Orgcode As String, ByVal DepartID As String, ByVal SubDepartID As String) As DataSet
            ...
            '0980819 人立修改，增加判斷 visable_flag='Y' 
            StrSQL.AppendLine(" SELECT *,(select top 1 seq from FSC_ORG sf where db1.Orgcode=sf.Orgcode and db1.Depart_id=sf.Depart_id ) as seq ")
        ...
        Public Function GetDepartByNotLikeDepartId(ByVal DepartID As String)
            ...
            StrSQL &= " from FSC_ORG Where depart_id not like @depart_id "
        ...
        Public Function GetDepartByRole_id(ByVal Orgcode As String, ByVal Role_id As String) As DataSet
            Dim sql As New StringBuilder
            sql.AppendLine("select *,(select top 1 seq from FSC_ORG sf where db1.Orgcode=sf.Orgcode and db1.Depart_id=sf.Depart_id ) as seq ")
            sql.AppendLine("from (select distinct m.depart_id, f.depart_name,f.OrgCode ")
            sql.AppendLine("        from member m ")
            sql.AppendLine("        inner join FSC_ORG f on m.orgcode=f.orgcode and m.depart_id=f.depart_id ")
        ...
        Public Function GetDepartIdAndNameByOrgcodeDepartID(ByVal Orgcode As String, ByVal DepartID As String) As DataSet
            ...
            sql.AppendLine(" from FSC_ORG where visable_flag='Y' ")
