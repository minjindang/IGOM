...
#Region "Field"
        ...
        Private _Syslogin_flag As String
#End Region
...
#Region "Property"
        ...
        Public Property Cold_datee() As String
            ...
            End Set
        End Property
        Public Property Syslogin_flag() As String
            Get
                Return _Syslogin_flag
            End Get
            Set(ByVal value As String)
                _Syslogin_flag = value
            End Set
        End Property
#End Region

        Public Function GetDataByOrgCode(ByVal OrgCode As String) As DataTable
            Return DAO.GetDataByOrgCode(OrgCode)
        End Function
        ...
        Public Function GetDataByIDcard(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Sub_depart_id As String, ByVal ID_card As String, ByVal Personnel_id As String, ByVal Include_Quit_job As Boolean, Optional ByVal Trans_All As Boolean = True) As DataTable
            Dim ds As DataSet = DAO.GetDataByIDcard(Orgcode, Depart_id, Sub_depart_id, ID_card, Personnel_id, Include_Quit_job, Trans_All)
            If ds Is Nothing Then Return Nothing
            Return ds.Tables(0)
        End Function
        ...
        Public Function GetColumnValue(ByVal Column_name As String, ByVal Id_card As String) As String
            If String.IsNullOrEmpty(Id_card) Then
                Return String.Empty
            End If
        ...
        Public Function GetColumnValue(ByVal Column_name As String, ByVal Orgocde As String, ByVal Depart_id As String, ByVal Id_card As String) As String
        ...
        Public Function GetMemberByBudgetType(ByVal Orgcode As String, ByVal depart_id As String, ByVal Budget_type As String) As DataTable
            Dim ds As DataSet = DAO.GetDataByBudgetType(Orgcode, depart_id, Budget_type)
            If ds Is Nothing Then Return Nothing
            Return ds.Tables(0)
        End Function

        Public Function GetMemberByBudgetType(ByVal Orgcode As String, ByVal Budget_type As String) As DataTable
        ...
        Public Function GetColumnByPersonnelId(ByVal Column_name As String, ByVal Personnel_id As String) As String
