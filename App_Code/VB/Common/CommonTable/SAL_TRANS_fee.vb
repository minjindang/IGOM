...
Namespace FSCPLM.Logic
    ...
    Public Class SAL_TRANS_fee
        Public DAO As SAL_TRANS_feeDAO

        Public Sub New()
            DAO = New SAL_TRANS_feeDAO()
        End Sub
        Public Function SelectGetNewFlowid(OrgCode As String) As DataTable
            Dim dt As DataTable = DAO.SelectGetNewFlowid(OrgCode)
        ...
        Public Function Add(Flow_id As String, Unit_code As String, User_id As String, Apply_ym As String, Apply_date As String, _
Pay_date As String, Fee_source As String, Org_code As String, ModUser_id As String, Mod_date As DateTime) As Integer
        ...
        Public Sub Modify(Id As Integer, Flow_id As String, Unit_code As String, User_id As String, Apply_ym As String, Apply_date As String, _
Pay_date As String, Fee_source As String, Org_code As String, ModUser_id As String, Mod_date As DateTime)
