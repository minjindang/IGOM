...
Namespace FSCPLM.Logic
    Public Class SAL_TRANS_feeDAO
        ...
        Public Function Insert(ps() As SqlParameter) As Integer
            ...
            StrSQL.Append(" INSERT INTO SAL_TRANS_fee ( ")
            StrSQL.Append(" Flow_id,Unit_code,User_id,Apply_ym,Apply_date, ")
            StrSQL.Append(" Pay_date,Fee_source,Org_code,ModUser_id,Mod_date ")
            StrSQL.Append("  ")
        ...
        Public Sub Update(ps() As SqlParameter)
            ...
            StrSQL.Append(" UPDATE SAL_TRANS_fee SET  ")
            StrSQL.Append(" Flow_id=@Flow_id,Unit_code=@Unit_code,User_id=@User_id,Apply_ym=@Apply_ym,Apply_date=@Apply_date, ")
            StrSQL.Append(" Pay_date=@Pay_date,Fee_source=@Fee_source,Org_code=@Org_code,ModUser_id=@ModUser_id,Mod_date=@Mod_date ")
            StrSQL.Append("  ")
        ...
        Public Function SelectAll(Org_code As String, Optional User_id As String = "", Optional Flow_id As String = "") As DataTable
            ...
            StrSQL.Append(" Flow_id,Unit_code,User_id,Apply_ym,Apply_date, ")
            StrSQL.Append(" Pay_date,Fee_source,Org_code,ModUser_id,Mod_date ")
            StrSQL.Append("  FROM SAL_TRANS_fee  ")
            ...
            StrSQL.Append("  ORDER BY  Apply_ym,Apply_date DESC ")
        ...
        Public Sub Delete(Id As Integer)
            Dim StrSQL As New System.Text.StringBuilder
            StrSQL.Append(" DELETE FROM SAL_TRANS_fee WHERE  Id=@Id  ")
        ...
        Public Function update(ByVal Orgcode As String, ByVal flow_id As String) As Integer
            ...
            sql.AppendLine(" update SAL_TRANS_fee set ModUser_id=@ModUser_id , Mod_date=getDate() ")
        ...
        Public Function SelectGetNewFlowid(OrgCode As String) As DataTable
            Dim StrSQL As New System.Text.StringBuilder
            StrSQL.Append(" SELECT TOP 1 * FROM SAL_TRANS_fee ORDER BY Flow_id DESC ")
            Dim ps() As SqlParameter = { _
