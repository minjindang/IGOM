...
Namespace FSCPLM.Logic
    Public Class OldMemberDAO
        ...
        Public Function insert(ByVal mem As OldMember) As Integer
            Dim sql As String = String.Empty

            sql = " INSERT INTO Old_Member "
        ...
        Public Function update(ByVal mem As OldMember) As Integer
            Dim sql As String = String.Empty

            sql = " UPDATE Old_Member "
            ...
            sql &= " , Cold_dates=@Cold_dates , Cold_datee=@Cold_datee , PEHYEAR=@PEHYEAR ,PEHDAY=@PEHDAY ,PEKIND=@PEKIND ,PEWKTYPE=@PEWKTYPE "
            sql &= " , PESEX=@PESEX, PEBIRTHD=@PEBIRTHD, PECRKCOD=@PECRKCOD, PEMEMCOD=@PEMEMCOD, PEACTDATE=@PEACTDATE, PELEVDATE=@PELEVDATE"
            sql &= " , PEPOINT=@PEPOINT, PEPROFESS=@PEPROFESS, PECHIEF=@PECHIEF, PEHDAY2=@PEHDAY2 "
            sql &= " where Personnel_id =@Personnel_id and Orgcode =@Orgcode "
            'sql &= " and Quit_job_flag=@Quit_job_flag "

            Dim aryParms(39) As SqlParameter
            aryParms(0) = New SqlParameter("@Id_card", SqlDbType.VarChar)
            aryParms(1) = New SqlParameter("@Personnel_id", SqlDbType.VarChar)
            aryParms(2) = New SqlParameter("@Title_no", SqlDbType.VarChar)
            aryParms(3) = New SqlParameter("@Orgcode", SqlDbType.VarChar)
            ...
            aryParms(26) = New SqlParameter("@PEHYEAR", SqlDbType.VarChar)
            aryParms(27) = New SqlParameter("@PEHDAY", SqlDbType.VarChar)
            aryParms(28) = New SqlParameter("@PEKIND", SqlDbType.VarChar)
            aryParms(29) = New SqlParameter("@PEWKTYPE", SqlDbType.VarChar)
            aryParms(30) = New SqlParameter("@PESEX", SqlDbType.VarChar)
            aryParms(31) = New SqlParameter("@PEBIRTHD", SqlDbType.VarChar)
            aryParms(32) = New SqlParameter("@PECRKCOD", SqlDbType.VarChar)
            aryParms(33) = New SqlParameter("@PEMEMCOD", SqlDbType.VarChar)
            aryParms(34) = New SqlParameter("@PEACTDATE", SqlDbType.VarChar)
            aryParms(35) = New SqlParameter("@PELEVDATE", SqlDbType.VarChar)
            aryParms(36) = New SqlParameter("@PEPOINT", SqlDbType.VarChar)
            aryParms(37) = New SqlParameter("@PEPROFESS", SqlDbType.VarChar)
            aryParms(38) = New SqlParameter("@PECHIEF", SqlDbType.VarChar)
            aryParms(39) = New SqlParameter("@PEHDAY2", SqlDbType.VarChar)
            aryParms(0).Value = mem.Id_card
            aryParms(1).Value = mem.Personnel_id
            aryParms(2).Value = mem.Title_no
            aryParms(3).Value = mem.Orgcode
            ...
            aryParms(26).Value = mem.PEHYEAR
            aryParms(27).Value = mem.PEHDAY
            aryParms(28).Value = mem.PEKIND
            aryParms(29).Value = mem.PEWKTYPE
            aryParms(30).Value = mem.PESEX
            aryParms(31).Value = mem.PEBIRTHD
            aryParms(32).Value = mem.PECRKCOD
            aryParms(33).Value = mem.PEMEMCOD
            aryParms(34).Value = mem.PEACTDATE
            aryParms(35).Value = mem.PELEVDATE
            aryParms(36).Value = mem.PEPOINT
            aryParms(37).Value = mem.PEPROFESS
            aryParms(38).Value = mem.PECHIEF
            aryParms(39).Value = mem.PEHDAY2
        ...
        Public Function update(ByVal Orgcode As String, ByVal personnal_id As String, ByVal dbid As String) As Integer
            Dim sql As String = String.Empty
            Dim cpa As String
            Dim dbs() As String = ConfigurationManager.AppSettings(Orgcode).ToString().Split(",")
            If dbid.Equals("1") Then
                cpa = dbs(0)
            Else
                cpa = dbs(1)
            End If
            sql = " UPDATE Old_Member "
            sql &= " SET  Personnel_id =m.Personnel_id, Title_no =m.Title_no "
            sql &= " , Orgcode =m.Orgcode, Depart_id =m.Depart_id, Sub_depart_id=m.Sub_depart_id, User_name =m.User_name, Email =m.Email"
            sql &= " , User_password =m.User_password, Boss_orgcode=m.Boss_orgcode, Boss_departid=m.Boss_departid, Boss_posid =m.Boss_posid"
            sql &= " , Boss_idcard =m.Boss_idcard, Budget_type =m.Budget_type , Role_id=m.Role_id, Quit_job_flag=m.Quit_job_flag " 'Metadb_id=m.Metadb_id
            sql &= " , Change_userid=m.Change_userid, Change_date=getdate() , Office_tel=m.Office_tel, Office_ext=m.Office_ext"
            sql &= " , Indigenous_flag=m.Indigenous_flag, Login_type=m.Login_type, Join_sdate=m.Join_sdate, Elected_officials_flag=m.Elected_officials_flag "
            sql &= " , Cold_dates=m.Cold_dates , Cold_datee=m.Cold_datee , PEHYEAR=e.PEHYEAR ,PEHDAY=e.PEHDAY ,PEKIND=e.PEKIND ,PEWKTYPE=e.PEWKTYPE "
            sql &= " , PESEX=e.PESEX, PEBIRTHD=e.PEBIRTHD, PECRKCOD=e.PECRKCOD, PEMEMCOD=e.PEMEMCOD, PEACTDATE=e.PEACTDATE, PELEVDATE=e.PELEVDATE"
            sql &= " , PEPOINT=e.PEPOINT, PEPROFESS=e.PEPROFESS, PECHIEF=e.PECHIEF, PEHDAY2=e.PEHDAY2 "
            sql &= " from member m," & cpa & "..cpape05m e "
            sql &= " where m.Orgcode =Old_Member.Orgcode and m.Orgcode=e.PEORG and m.Personnel_id=Old_Member.Personnel_id and m.Personnel_id=e.pecard "
            sql &= " and Old_Member.Personnel_id=@Personnel_id and m.Orgcode=@Orgcode "

            Dim aryParms(1) As SqlParameter
            aryParms(0) = New SqlParameter("@Personnel_id", SqlDbType.VarChar)
            aryParms(0).Value = personnal_id
        ...
        Public Function GetDataByPId(ByVal PId As String) As DataSet
            ...
            StrSQL = "SELECT * FROM Old_Member WHERE Personnel_id=@PId"
        ...
        Public Function GetDataAll(ByVal PId As String) As DataSet
            Dim StrSQL As String = String.Empty
            StrSQL = "SELECT * FROM Old_Member WHERE Id_card=@PId"
            Dim param As SqlParameter = New SqlParameter("@PId", SqlDbType.VarChar)
            param.Value = PId
        ...
        Public Function GetDataByIDcard(ByVal Orgcode As String, _
                                        ...
                                        ByVal Include_Quit_job As Boolean) As DataSet
            ...
            sql.AppendLine("FROM Old_Member m ")
        ...
        Public Function GetDataByBudgetType(ByVal Orgcode As String, ByVal Depart_id As String, ByVal Budget_type As String) As DataSet
            Dim StrSQL As String = String.Empty
            StrSQL = "SELECT * FROM Old_Member WHERE Orgcode=@Orgcode AND Budget_type=@Budget_type "
        ...
        Public Function UpdateBudgetType(ByVal ID_card As String, ByVal Budget_type As String, ByVal Change_userid As String, ByVal Orgcode As String) As Integer
            ...
            StrSQL = "UPDATE Old_Member SET Budget_type='{0}', Change_userid='{1}', Change_date='{2}' WHERE ID_card='{3}' and Orgcode='{4}'"
            Try
                Using (SqlCmd)
        ...
        Public Function UpdateQuit_job_flag(ByVal Quit_job_flag As String, ByVal Id_card As String) As Integer
            ...
            sql.Append("UPDATE Old_Member SET Quit_job_flag=@Quit_job_flag, Change_userid=@Change_userid, Change_date= GETDATE() ")
        ...
        Public Function DeleteIdcard(ByVal Orgcode As String, ByVal Id_card As String) As Integer
            ...
            sql.Append("delete from Old_Member ")
        ...
        Public Function DeletePersonId(ByVal Orgcode As String, ByVal PersonnalID As String) As Integer
            Dim sql As New StringBuilder

            sql.Append("delete from Old_Member ")
            sql.Append("WHERE Orgcode=@Orgcode and  Personnel_id=@PersonnalID")

            Dim params() As SqlParameter = { _
            New SqlParameter("@Orgcode", SqlDbType.VarChar), _
            New SqlParameter("@PersonnalID", SqlDbType.VarChar)}
            params(0).Value = Orgcode
            params(1).Value = PersonnalID
        ...
        Public Function UpdateBOSS(ByVal Orgcode As String, ByVal DepartID As String, ByVal Id_Card As String, ByVal Boss_orgcode As String, ByVal Boss_departid As String, ByVal Boss_posid As String, ByVal Boss_idcard As String) As Integer
            ...
            sql.Append(" UPDATE Old_Member SET Boss_orgcode=@Boss_orgcode, Boss_departid=@Boss_departid, Boss_posid=@Boss_posid, Boss_idcard=@Boss_idcard ")
        ...
        Public Function GetDDLMemberInfo(ByVal Orgcode As String, ByVal DepartID As String, ByVal LoginID As String, ByVal flag As Boolean) As DataSet
            ...
            StrSQL = "SELECT distinct ID AS IDNo ,isnull((select top 1 detail_code_name  from detail_code  where master_code_id='1012'  and title_no=detail_code_id),'') + '/' + User_name as User_name, user_name as Name ,Depart as DepartID FROM Old_Member"
            StrSQL = StrSQL + " Where"
            If Orgcode <> "" Then
        ...
        Public Function GetDataBymcIDdcID(ByVal Orgcode As String, ByVal MasterCodeID As String, ByVal Idno As String) As DataSet
            ...
            sql.AppendLine(" FROM detail_code d , Old_Member m , FSCorg f ")
            sql.AppendLine(" WHERE ")
        ...
        Public Function getAllMembers(ByVal Metadb_id As String) As DataTable
            ...
            sql.AppendLine(" FROM Old_Member m, detail_code d, FSCorg f")
