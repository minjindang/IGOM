...
Namespace FSCPLM.Logic
    ...
    Public Class SAL_VOL_fee
        Public DAO As SAL_VOL_feeDAO

        Public Sub New()
            DAO = New SAL_VOL_feeDAO()
        End Sub
        ...
        Public Function Add(Flow_id As String, User_id As String, Unit_code As String, Apply_ym As String, Apply_date As String, _
Fee_source As String, Pay_date As String, Org_code As String, ModUser_id As String, Mod_date As DateTime) As Integer
        ...
        Public Sub Modify(Id As Integer, Flow_id As String, User_id As String, Unit_code As String, Apply_ym As String, Apply_date As String, _
Fee_source As String, Pay_date As String, Org_code As String, ModUser_id As String, Mod_date As DateTime)
