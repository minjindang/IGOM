...
#End Region
        ...
        Public Sub ExportToHTML()
            ...
            If _ContextString <> "" Then
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "inline; filename=" & _ExportFileName)
        ...
        Private Sub ExportToFile(ByVal theFileType As ExportFileType)
            ...
            If _ContextString <> "" Then
                ...
                If theFileType = ExportFileType.MS_Word Then
                    ...
                    '建立輸出串流
                    Dim theStreamWriter As New System.IO.StreamWriter(theFileInfo.FullName, False, System.Text.Encoding.Default) '用 UTF8 會亂碼
                    ...
                    '建立檔案輸入串流物件 
                    Dim buf() As Byte = System.IO.File.ReadAllBytes(HttpContext.Current.Server.MapPath("../../Report/WordTemp/") & fileName & ".doc")
                    ...
                    File.Delete(HttpContext.Current.Server.MapPath("../../Report/WordTemp/") & fileName & ".doc")
                    ...
                    HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=" & HttpUtility.UrlEncode(Me.ExportFileName, Encoding.UTF8) & ".doc")
