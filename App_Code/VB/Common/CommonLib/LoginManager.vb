...
#Region "Property"
    ...
    Public Shared ReadOnly Property DepartName() As String
        Get
            Return GetTicketUserData(LoginUserData.DepartName)
        End Get
    End Property
    ...
    Public Shared ReadOnly Property Email() As String
        Get
            Return GetTicketUserData(LoginUserData.Email)
        End Get
    End Property
    ...
    Public Shared ReadOnly Property ADId() As String
        Get
            Return GetTicketUserData(LoginUserData.ADId)
        End Get
    End Property


    Public Shared ReadOnly Property EmployeeType() As String
        Get
            Return GetTicketUserData(LoginUserData.EmployeeType)
        End Get
    End Property
#End Region
