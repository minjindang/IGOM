...
namespace SALPLM.Logic
{
    public class SAL2115
    {
        ...
        {
            DataTable dt = DAO.getReportData(strYear, strMonth, strUnit, strName, strtype, strNum, strOrgCode, strPayBudgeCode);
     ...
     , string BASE_SEQNO   //列印之人員
        ...
        {
            DataTable dt = DAO.getReportData2(strYear, strMonth, strLogDeptCD, BASE_SEQNO, strPayBudgeCode);
            if (dt == null || dt.Rows.Count == 0)
            {
                return null;
            }
