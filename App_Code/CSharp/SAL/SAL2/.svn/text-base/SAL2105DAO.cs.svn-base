...
/// 薪給發放清冊
/// </summary>
public class SAL2105DAO : BaseDAO
{
	public SAL2105DAO()
	{
		//
    ...
    public SAL2105DAO(SqlConnection conn)
        : base(conn)
    {
        ...
        )
    {
        string strSQL =
            ...
            "isnull(( select CODE_DESC1 from SYS_CODE where CODE_SYS ='002' and CODE_TYPE='006' and CODE_NO = PAYO_ORG_L1 ) ,'') + " + //
            ...
            ", isnull(( select sum(PAYOD_AMT) from SAL_SAPAYOD where PAYOD_ORGID = PAYO_ORGID and PAYOD_SEQNO = PAYO_SEQNO and PAYOD_KIND = PAYO_KIND and PAYOD_YM = PAYO_YYMM and PAYOD_DATE = PAYO_DATE and PAYOD_CODE_SYS = '003' and PAYOD_CODE_TYPE = '002' and PAYOD_CODE_NO = '002' and PAYOD_CODE = '001'),0)  " + //
            "- case when PAYO_FINS_KIND = '001' then dbo.count_health(payo_fin_amt,payo_fins_nol,payo_fins_noq,payo_fins_noh,payo_fins_nof,payo_fins_noq_nol,payo_fins_noh_nol,payo_fins_no,dbo.Get_Para('006','P','006','001',payo_yymm),dbo.Get_Para('006','P','008','007',payo_yymm)) else 0 end as item011  " + //-- 公健保費
            ", case when PAYO_FINS_KIND = '001' then dbo.count_health(payo_fin_amt,payo_fins_nol,payo_fins_noq,payo_fins_noh,payo_fins_nof,payo_fins_noq_nol,payo_fins_noh_nol,payo_fins_no,dbo.Get_Para('006','P','006','001',payo_yymm),dbo.Get_Para('006','P','008','007',payo_yymm)) else 0 end as item012  " + //-- 眷屬健保費
            ...
            ", isnull(( select sum(PAYOD_AMT) from SAL_SAPAYOD where PAYOD_ORGID = PAYO_ORGID and PAYOD_SEQNO = PAYO_SEQNO and PAYOD_KIND = PAYO_KIND and PAYOD_YM = PAYO_YYMM and PAYOD_DATE = PAYO_DATE and PAYOD_CODE_SYS = '003' and PAYOD_CODE_TYPE = '002' and PAYOD_CODE_NO = '002'),0)  " + //
            "- case when PAYO_FINS_KIND in ('002','003') then dbo.count_health(payo_fin_amt,payo_fins_nol,payo_fins_noq,payo_fins_noh,payo_fins_nof,payo_fins_noq_nol,payo_fins_noh_nol,payo_fins_no,dbo.Get_Para('006','P','006','001',payo_yymm),dbo.Get_Para('006','P','008','007',payo_yymm)) else 0 end as item015  " + //-- 勞健保費
            ", case when PAYO_FINS_KIND in ('002','003') then dbo.count_health(payo_fin_amt,payo_fins_nol,payo_fins_noq,payo_fins_noh,payo_fins_nof,payo_fins_noq_nol,payo_fins_noh_nol,payo_fins_no,dbo.Get_Para('006','P','006','001',payo_yymm),dbo.Get_Para('006','P','008','007',payo_yymm)) else 0 end as item016  " + //-- 眷屬健保費
            ...
            ", isnull(( select sum(PAYOD_AMT) from SAL_SAPAYOD where PAYOD_ORGID = PAYO_ORGID and PAYOD_SEQNO = PAYO_SEQNO and PAYOD_KIND = PAYO_KIND and PAYOD_YM = PAYO_YYMM and PAYOD_DATE = PAYO_DATE and PAYOD_CODE_SYS = '005' and PAYOD_CODE_TYPE = '002' and PAYOD_CODE_NO <> '048' and PAYOD_CODE_NO <> '003' and PAYOD_CODE_NO <> '002' and PAYOD_CODE_NO <> '001' ),0) as item025  " + //其他代扣款項
            ...
            ", isnull(( select CODE_DESC1 from SYS_CODE where CODE_SYS ='002' and CODE_TYPE='006' and CODE_NO = PAYO_IN_L1 ) ,'') + "+
            " isnull(( select CODE_DESC1 from SYS_CODE where CODE_SYS ='002' and CODE_TYPE='003' and CODE_NO = PAYO_IN_L3) ,'') +" +
