<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SYS3102_01.aspx.vb" Inherits="SYS3102_01"  %>
        ...
        <td>            
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" Borderwidth="0px"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Depart_id" HeaderText="單位代號" />
                    <asp:BoundField DataField="Depart_name" HeaderText="單位名稱" />
                    <asp:BoundField DataField="Seq" HeaderText="排序" />
                    <asp:BoundField DataField="VisableFlag" HeaderText="是否顯示" />
