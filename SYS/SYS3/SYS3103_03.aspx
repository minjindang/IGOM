<%@ Page Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="SYS3103_03.aspx.vb" Inherits="SYS3103_03"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="htmltable_Left" style="width:120px">
            排序</td>
        <td class="htmltable_Right" style="width:230px">
            <asp:TextBox ID="tbCODE_SORT" runat="server" MaxLength="4" />
        </td>
    </tr>  
    <tr>
        <td class="htmltable_Bottom" colspan="2">
            <asp:Button ID="cbAdd" runat="server" Text="新增" />
            <asp:Button ID="cbBack" runat="server" Text="回上層代碼" />
