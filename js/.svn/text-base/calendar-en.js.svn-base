...
// Zapatec.Calendar EN language
// Author: Mihai Bazon, <mihai_bazon@yahoo.com>
// Encoding: any
// Distributed under the same terms as the Zapatec.Calendar itself.
...
"For latest version visit: http://www.dynarch.com/projects/Zapatec.Calendar/\n" +
...
Zapatec.Calendar._TT["PREV_YEAR"] = "上一年 (長按時顯示選單)";
Zapatec.Calendar._TT["PREV_MONTH"] = "上一月 (長按時顯示選單)";
Zapatec.Calendar._TT["GO_TODAY"] = "到今日";
Zapatec.Calendar._TT["NEXT_MONTH"] = "下一月 (長按時顯示選單)";
Zapatec.Calendar._TT["NEXT_YEAR"] = "下一年 (長按時顯示選單)";
...
Zapatec.Calendar._TT["TT_DATE_FORMAT"] = "%Y年%b%e日 星期%a";
