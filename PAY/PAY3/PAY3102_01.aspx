<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PAY3102_01.aspx.vb" Inherits="PAY_PAY3_PAY3102_01" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="Div_Approve_Query" runat="server">
        <table class="tableStyle99" width="100%">
            <tr>
                <td class="htmltable_Title" colspan="4">非預借零用金維護-查詢
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtPettyCash_nos_S" runat="server" Width="80px"></asp:TextBox>
                    ~
                    <asp:TextBox ID="txtPettyCash_nos_E" runat="server" Width="80px"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtUse_type" runat="server" Enabled="False" Width="80px"></asp:TextBox>
        ...
        <div align="center">
            <asp:Button ID="AddBtn" runat="server" Text="新增" PostBackUrl="~/PAY/PAY3/PAY3102_02.aspx" />
