<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PAY3105_03.aspx.vb" Inherits="PAY_PAY3_PAY3105_03" %>
    ...
    <table class="tableStyle99" width="100%">
        ...
        <tr>
         ...
         <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtBeneficiary_id" runat="server"></asp:TextBox>
            </td>
        </tr>
