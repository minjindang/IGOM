<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PAY3102_02.aspx.vb" Inherits="PAY_PAY3_PAY3102_02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tableStyle99" width="100%">
        <tr>
            <td class="htmltable_Title" colspan="4">非預借零用金維護-新增
            </td>
        </tr> 
        <tr>
        ...
        <tr>
            ...
            <td style="width: 326px">
                ...
                <asp:TextBox ID="txtPurchaseForm_sn" runat="server" MaxLength="2" AutoPostBack="True" Width="40"></asp:TextBox>
            </td>
