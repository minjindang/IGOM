<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PAY3201_02.aspx.vb" Inherits="PAY_PAY3_PAY3201_02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tableStyle99" width="100%">
        <tr>
            <td class="htmltable_Title" colspan="4">審查收入維護作業-新增
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="htmltable_Left"><span style="color: red;">*</span>收據編號
            </td>
        ...
        <tr>
            <td class="htmltable_Left"><span style="color: red;">*</span>件數
            </td>
            <td style="width: 326px">
                <asp:TextBox ID="txtExamine_cnt" runat="server" AutoPostBack="true" ></asp:TextBox>
               <%-- <asp:RegularExpressionValidator runat="server" id="rexNumber" controltovalidate="txtExamine_cnt"
        ...
        <tr>
            ...
            <td style="width: 326px">
                ...
                <asp:RegularExpressionValidator runat="server" id="rexNumber" controltovalidate="txtCheck1_nos"
                     validationexpression="^\d+?$" errormessage="只能輸入數字!!" />
            </td>
            ...
            <td style="width: 326px">
                ...
                <asp:RegularExpressionValidator runat="server" id="RegularExpressionValidator1" controltovalidate="txtCheck2_nos"
                     validationexpression="^\d+?$" errormessage="只能輸入數字!!" />
            </td>
        </tr>
    </table>
    <div align="center">
        ...
        <asp:Button ID="CopyBtn" runat="server" Text="複製上一筆" />
        <asp:Button ID="ResetBtn" runat="server" Text="清空重填" />
        <asp:Button ID="btnBack" runat="server" Text="回查詢" />
    </div>
</asp:Content>
