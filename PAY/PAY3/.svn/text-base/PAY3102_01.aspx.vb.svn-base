...
Partial Class PAY_PAY3_PAY3102_01
    ...
    Private Sub BindGV()
        Dim dt As DataTable = dao.GetAll(LoginManager.OrgCode, ucFiscalYear_id.Year.ToString(), txtPCList_id.Text, _
                                         ...
                                         Me.ucBeneficiary.Beneficiary_ID, txtUse_type.Text, ucInvoice_date.Text)
        div1.Visible = True
    ...
    Protected Sub GridViewA_RowCommand(sender As Object, e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridViewA.RowCommand
        ...
        If e.CommandName = "Maintain" Then
            Page.Response.Redirect(String.Format("~/PAY/PAY3/PAY3102_03.aspx?SerialNumber_id={0}", SerialNumber_id))
