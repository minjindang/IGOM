<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="false" CodeFile="PAY3101_02.aspx.vb" Inherits="PAY_PAY3_PAY3101_02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="tableStyle99" width="100%">
        <tr>
            <td class="htmltable_Title" colspan="4">預借零用金維護-新增
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtPrepay_id" runat="server" MaxLength="6" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 326px">
                <asp:TextBox ID="txtPettyCash_nos" runat="server" MaxLength="6" Enabled="false"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 326px">
                <asp:TextBox ID="txtPurchaseForm_id" runat="server" MaxLength="6" width="70"></asp:TextBox>
                <asp:TextBox ID="txtPurchaseForm_sn" runat="server" AutoPostBack="True" MaxLength="2"  Width="40"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td style="width: 326px">
                <asp:TextBox ID="txtUse_type" runat="server" MaxLength="8" Width="80" Enabled="false"></asp:TextBox>
            ...
            <td style="width: 326px">
                ...
                <!--
                <asp:Label ID="lbTip1" runat="server" ForeColor="Blue" Text="請購單號不得大於六碼"></asp:Label>
                -->
            </td>
        </tr>
        <tr>
    ...
    <div align="center">
        ...
        <asp:Button ID="Back" runat="server" Text="回上頁" />
