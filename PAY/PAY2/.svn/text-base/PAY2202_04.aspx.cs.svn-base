...
public partial class PAY_PAY2_PAY2202_04 : System.Web.UI.Page
{
    ...
    {
        DataTable dt = dao.GetReportDataPrintType3(Receipt_dateS, Receipt_dateE, PayMode_type, ExamineIncome_type, Payer_id);
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            theDTReport = new CommonLib.DTReport(Server.MapPath("~/Report/PAY/PAY2202_04.mht"), dt);
            theDTReport.Param = strParam;
            theDTReport.ExportFileName = "付款人明細表";
