...
Partial Class uc_ucSaCode
    ...
    Protected Sub BindCode4Multi()
        ...
        Else
            ...
            CheckBoxList_Code_no.DataSource = sdao.GetData(Code_Remark1, Orgid, Code_sys, Code_type)
            CheckBoxList_Code_no.DataBind()
        End If
        ...
        If Not (String.IsNullOrEmpty(Code_Kind)) Then
            ...
            CheckBoxList_Code_no.DataSource = sdao.GetData2(Code_Remark1, Orgid, Code_sys, Code_Kind, Code_type)
            CheckBoxList_Code_no.DataBind()
        End If
    ...
    Private _ddlDefaultValue As Boolean= False 
    Public Property DDLDefaultValue() As Boolean
        Get
            Return _ddlDefaultValue
        End Get
        Set(ByVal value As Boolean)
            _ddlDefaultValue = value
        End Set
    End Property
        ...
        If (ShowType) Then
            ...
            Select Case ControlType
                Case Control.DropDownList
                    ...
                    If DDLDefaultValue Then
                        DropDownList_code_no.Items.Insert(0, New ListItem("請選擇", "-1"))
                    End If
        ...
        Else
            ...
            Select Case ControlType
                Case Control.DropDownList
                    ...
                    DropDownList_code_no.DataSource = sdao.GetData(Code_Remark1, Orgid, Code_sys, Code_type) '20140429 Eliot Chen '20140803Anthony Wang
                    DropDownList_code_no.DataBind()
                ...
                Case Control.RadioButtonList
                    ...
                    RadioButton_Code_no.DataSource = sdao.GetData(Code_Remark1, Orgid, Code_sys, Code_type) '20140429 Eliot Chen '20140803 Anthony Wang
                    RadioButton_Code_no.DataBind()
                Case Control.CheckBoxList
                    CheckBoxList_Code_no.DataTextField = "CODE_DESC1"
                    CheckBoxList_Code_no.DataValueField = "CODE_NO"

                    CheckBoxList_Code_no.DataSource = sdao.GetData(Code_Remark1, Orgid, Code_sys, Code_type) '20140429 Eliot Chen '20140803 Anthony Wang
                    CheckBoxList_Code_no.DataBind()
            End Select
        End If
        ...
        If Not (String.IsNullOrEmpty(Code_Kind)) Then
            ...
            Select Case ControlType
                Case Control.DropDownList
                    ...
                    DropDownList_code_no.DataSource = sdao.GetData2(Code_Remark1, Orgid, Code_sys, Code_Kind, Code_type)
                    DropDownList_code_no.DataBind()
                ...
                Case Control.RadioButtonList
                    ...
                    RadioButton_Code_no.DataSource = sdao.GetData2(Code_Remark1, Orgid, Code_sys, Code_Kind, Code_type)
                    RadioButton_Code_no.DataBind()
                Case Control.CheckBoxList
                    CheckBoxList_Code_no.DataTextField = "CODE_DESC1"
                    CheckBoxList_Code_no.DataValueField = "CODE_NO"
    ...
    Public Property Orgid() As String
        Get
            ...
            strOrgID = ""
            'strOrgID = "355000000I" '環保署預設資料
            If Me.TextBox_orgid.Text <> "" Then
                strOrgID = Me.TextBox_orgid.Text
            End If
            Return strOrgID
        End Get
        Set(ByVal value As String)
    ...
    '2014/8/3 Anthony Wnag
    '增加 code_remark1相關設定
    Public Property Code_Remark1() As String
        Get
            Dim strCodeRemark As String
            strCodeRemark = ""
            If Me.TextBox_code_remark1.Text <> "" Then
                strCodeRemark = Me.TextBox_code_remark1.Text
            End If
            Return strCodeRemark
        End Get
        Set(ByVal value As String)
            Me.TextBox_code_remark1.Text = value
        End Set
    End Property

    Public Property CommandArgument() As String
        Get
            Return Me.TextBox_CommandArgument.Text
        End Get
        Set(ByVal value As String)
            Me.TextBox_CommandArgument.Text = value
        End Set
    End Property

    Public Property TempValue() As String
        Get
            Return Me._TempValue.Text
        End Get
        Set(ByVal value As String)
            Me._TempValue.Text = value
        End Set
    End Property
    ...
    Public Property ShowCode As Boolean
        Get
            ...
            Boolean.TryParse(Me.TextBox_ShowCode.Text, rv)
            Return rv
        End Get
        Set(ByVal value As Boolean)
            Me.TextBox_ShowCode.Text = value
        End Set
    End Property
    ...
    '' 20140730 add Budget_Code
    Public Property Budget_Code As String
        Get
            Return Me.TextBox_Budget_Code.Text
        End Get
        Set(ByVal value As String)
            Me.TextBox_Budget_Code.Text = value
        End Set
    End Property
    ...
    Protected Sub DropDownList_code_no_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList_code_no.DataBound, RadioButton_Code_no.DataBound
        ...
        ''20140721 add 顯示代碼
        If ShowCode Then
            For Each li As ListItem In Me.DropDownList_code_no.Items
        ...
        '' 20140730 add Budget_Code
        If (Me.TextBox_Budget_Code.Text = "Y") And (Code_sys = "002" And Code_type = "018") Then

            Select Case ControlType
                Case Control.DropDownList
                    Me.DropDownList_code_no.Items.Add(New ListItem("低污染車補助", "091"))
                    Me.DropDownList_code_no.Items.Add(New ListItem("油氣雙燃料車", "092"))
                Case Control.RadioButtonList
                    Me.RadioButton_Code_no.Items.Add(New ListItem("低污染車補助", "091"))
                    Me.RadioButton_Code_no.Items.Add(New ListItem("油氣雙燃料車", "092"))
                Case Control.CheckBoxList
                    Me.CheckBoxList_Code_no.Items.Add(New ListItem("低污染車補助", "091"))
                    Me.CheckBoxList_Code_no.Items.Add(New ListItem("油氣雙燃料車", "092"))
            End Select
    ...
    Protected Sub CheckBoxList_Code_no_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxList_Code_no.DataBound
        '' 20140730 add Budget_Code
        If (Me.TextBox_Budget_Code.Text = "Y") And (Code_sys = "002" And Code_type = "018") Then
            Me.CheckBoxList_Code_no.Items.Add(New ListItem("低污染車補助", "091"))
            Me.CheckBoxList_Code_no.Items.Add(New ListItem("油氣雙燃料車", "092"))
