...
public partial class MAI_MAI4_MAI4101_02 : BaseWebForm
{
    ...
    protected void DoneBtn_Click(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(msg))
        {
            string mtItemTypes = cblMtItem_type.Items.Cast<ListItem>()
                           ...
                           .Select(i => i.Value)
                           .Aggregate((i, j) => i + ";" + j);
             msg = dao.Add(txtMaintainerPhone_nos.Text, ucMember.SelectedItem.Text, ucMaintain_type.Code_no, mtItemTypes, ucDept.SelectedValue, ucMember.SelectedValue);
